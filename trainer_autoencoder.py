...
def save_model_sd(model: AutoEncoder, project_dir: Path) -> None:
        ...
        while current_step < args.total_steps:
            ...
            for _ in range(args.gradient_accumulation_steps):
                ...
                with accelerator.autocast(), accelerator.accumulate(model):
                    ...
                    loss = mse_loss + kl_loss * args.kl_weight
                    ...
                    batch_mse_loss += mse_loss.item() / args.gradient_accumulation_steps
