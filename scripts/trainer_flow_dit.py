...
def save_model_state(model: OsuFusionFlowDiT, project_dir: Path) -> None:
...
MODEL_CONFIGS = {"s": FlowDiTConfig_S, "m": FlowDiTConfig_M, "l": FlowDiTConfig_L}
...
def train(args: ArgumentParser) -> None:  # noqa: C901
    ...
    accelerator.init_trackers(project_name="OsuFusion-Flow")
...
def main() -> None:
    args = ArgumentParser(description="Train OsuFusion Flow DiT")
